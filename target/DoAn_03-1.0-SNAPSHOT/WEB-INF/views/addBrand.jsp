            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="<c:url value="/resources/assets/images/avatars/user.jpg" />"
                             alt="Jason's Photo"/>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="index.html">Quản lý nhà sản xuất</a>
                    </li>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form:form method="post" action="${url}" modelAttribute="brandFormObj"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <br><br>                                    <span id="nameEr" style="color: #ff0000"></span>
        ...
        $("#name").blur(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response == 'exist') {
                        $('#nameEr').html("Username đã tồn tại");
                    } else {
                        $('#nameEr').html("");
                    }
                    if (name == '') {
